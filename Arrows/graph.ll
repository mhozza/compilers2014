...
%R440 = icmp ne i32 %R381, 0
br i1 %R440, label %L17, label %L18
L17:
%R382 = alloca i32
%R383 = load i32* %R343
...
%R387 = alloca i32
store i32 3, i32* %R387
%R388 = load i32* %R387
%R385 = alloca i32, i32 %R388
%R389 = getelementptr i32* %R385, i32 0
store i32 78, i32* %R389
%R390 = getelementptr i32* %R385, i32 1
store i32 79, i32* %R390
%R391 = getelementptr i32* %R385, i32 2
store i32 0, i32* %R391
%R395 = load i32* %R384
%R394 = getelementptr i32* %R340, i32 %R395
%R396 = load i32* %R386
%R393 = getelementptr i32* %R385, i32 %R396
%R397 = load i32* %R387
call void @arrcopy(i32* %R394, i32* %R393, i32 %R397)
br label %L19
L18:
%R432 = add i32 0, 0
%R433 = load i32* %R240
%R399 = load i32* %R266
store i32 %R432, i32* %R266
br label %L14
L14:
%R434 = load i32* %R266
%R435 = icmp ne i32 %R433, %R434
br i1 %R435, label %L15, label %L16
L15:
%R400 = load i32* %R266
%R401 = load i32* %R240
%R402 = load i32* %R244
%R403 = alloca i32
%R404 = load i32* %R259
store i32 %R404, i32* %R403
%R405 = alloca i32
store i32 0, i32* %R405
%R406 = alloca i32
%R407 = load i32* %R250
store i32 %R407, i32* %R406
%R408 = alloca i32
store i32 0, i32* %R408
%R409 = call i32 @find(i32 %R400, i32 %R401, i32 %R402, i32* %R256, i32* %R247)
%R410 = load i32* %R364
%R411 = icmp ne i32 %R409, %R410
%R412 = sext i1 %R411 to i32
%R431 = icmp ne i32 %R412, 0
br i1 %R431, label %L12, label %L13
L12:
%R413 = alloca i32
%R414 = load i32* %R343
store i32 %R414, i32* %R413
%R415 = alloca i32
store i32 0, i32* %R415
%R417 = alloca i32
store i32 0, i32* %R417
%R418 = alloca i32
store i32 4, i32* %R418
%R419 = load i32* %R418
%R416 = alloca i32, i32 %R419
%R420 = getelementptr i32* %R416, i32 0
store i32 78, i32* %R420
%R421 = getelementptr i32* %R416, i32 1
store i32 73, i32* %R421
%R422 = getelementptr i32* %R416, i32 2
store i32 69, i32* %R422
%R423 = getelementptr i32* %R416, i32 3
store i32 0, i32* %R423
%R427 = load i32* %R415
%R426 = getelementptr i32* %R340, i32 %R427
%R428 = load i32* %R417
%R425 = getelementptr i32* %R416, i32 %R428
%R429 = load i32* %R418
call void @arrcopy(i32* %R426, i32* %R425, i32 %R429)
br label %L13
L13:
%R430 = add i32 0, 0
%R437 = load i32* %R266
%R436 = add i32 %R437, 1
store i32 %R436, i32* %R266
br label %L14
L16:
%R439 = add i32 0, 0
br label %L19
...
%R443 = alloca i32
store i32 0, i32* %R443
%R444 = load i32* %R441
%R445 = load i32* %R443
%R446 = getelementptr i32* %R340, i32 %R445
call void @printString(i32* %R446, i32 %R444)
call void @printLine()
ret i32 0
}
